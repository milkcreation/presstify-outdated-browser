<?php
/**
 * @var \tiFy\App\Templates\TemplateBaseController $this
 */
?>
...
<div id="outdated" class="tiFyOutdatedBrowser">
    ...
    <p>
        <?php _e('Pour afficher de manière satisfaisante le contenu de ce site', 'tify'); ?>
        <a id="btnUpdateBrowser" href="http://outdatedbrowser.com/fr" target="_blank">
            <?php _e('Télécharger Google Chrome', 'tify'); ?>
        </a>
    </p>
    <p class="last">
